...
mod <- gam(form, family = stackFamily(X, createGaussian(y)))

## Plot estimated aplhas vs true
nu1Hat <- predict(mod, type = "terms")[, 1] + mod$coefficients[1]
nu2Hat <- predict(mod, type = "terms")[, 2] + mod$coefficients[11]

a1Hat <- exp(nu1Hat)
a2Hat <- exp(nu2Hat)

plot(a1Hat, type = "l", ylim = range(c(a1Hat, a1)))
lines(a1, col = "red")

plot(a2Hat, type = "l", ylim = range(c(a2Hat, a2)))
lines(a2, col = "red")
```
