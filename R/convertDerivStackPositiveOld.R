...
#'
#' @description It is old because it only calculates derivatives with respect to 
...
#' @param d1b (p(K-1))xm matrix of derivatives of the Hessian with respect to the smoothing parameters
#' @param deriv 0: just grad and Hess, 1: first deriv of Hess
#'
#' @name convertDerivStackPositiveOld
#' @rdname convertDerivStackPositiveOld
#' @export
#' 
convertDerivStackPositiveOld <- function(param, theta, X, Z, le, lee, leee = 0, 
                              d1b = 0, deriv = 0) {
